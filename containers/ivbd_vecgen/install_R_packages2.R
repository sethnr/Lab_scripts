###############################################################################
# install additional R packages (addition to GATK)			      #
###############################################################################
...
additionals = c("gridExtra","ggmap","lubridate","knitr","igraph","ggnetwork","ape","phangorn","zoo","Rcpp")

install.packages(additionals,repos=repos,clean=TRUE)
